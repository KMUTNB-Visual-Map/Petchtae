import { $ as Color, $a as Raycaster, $i as PolyhedronGeometry, $n as InterpolationSamplingMode, $o as Texture, $r as MeshPhongMaterial, $s as getConsoleFunction, $t as EllipseCurve, A as BasicShadowMap, Aa as RGBA_ASTC_8x8_Format, Ai as ObjectLoader, An as HalfFloatType, Ao as Spherical, Ar as LinearToneMapping, As as Vector4, At as Data3DTexture, B as BufferGeometry, Ba as RGBIntegerFormat, Bi as OrthographicCamera, Bn as InstancedBufferGeometry, Bo as StaticCopyUsage, Br as MaterialLoader, Bs as WebXRController, Bt as DepthTexture, C as AudioAnalyser, Ca as RGBA_ASTC_4x4_Format, Ci as NormalGAPacking, Cn as GreaterDepth, Co as ShortType, Cr as LinearFilter, Cs as UnsignedIntType, Ct as CullFaceNone, D as AxesHelper, Da as RGBA_ASTC_6x6_Format, Di as NotEqualStencilFunc, Dn as GreaterStencilFunc, Do as Source, Dr as LinearMipmapLinearFilter, Ds as VSMShadowMap, Dt as CustomToneMapping, E as AudioLoader, Ea as RGBA_ASTC_6x5_Format, Ei as NotEqualDepth, En as GreaterEqualStencilFunc, Eo as SkinnedMesh, Er as LinearMipMapNearestFilter, Es as UnsignedShortType, Et as CustomBlending, F as Box3, Fa as RGBA_S3TC_DXT1_Format, Fi as OneMinusConstantColorFactor, Fn as ImageLoader, Fo as Sprite, Fr as LoopOnce, Fs as WebGLArrayRenderTarget, Ft as DecrementStencilOp, G as CameraHelper, Ga as RGB_PVRTC_2BPPV1_Format, Gi as Plane, Gn as Int8BufferAttribute, Go as StreamDrawUsage, Gr as MaxEquation, Gs as ZeroSlopeEnding, Gt as DodecahedronGeometry, H as ByteType, Ha as RGB_BPTC_UNSIGNED_Format, Hi as PCFSoftShadowMap, Hn as InstancedMesh, Ho as StaticReadUsage, Hr as Matrix2, Hs as WrapAroundEnding, Ht as DirectionalLight, I as Box3Helper, Ia as RGBA_S3TC_DXT3_Format, Ii as OneMinusDstAlphaFactor, In as ImageUtils, Io as SpriteMaterial, Ir as LoopPingPong, Is as WebGLCoordinateSystem, It as DecrementWrapStencilOp, J as CatmullRomCurve3, Ja as RGDepthPacking, Ji as PointLight, Jn as InterleavedBufferAttribute, Jo as SubtractEquation, Jr as MeshDepthMaterial, Js as cloneUniforms, Jt as DstColorFactor, K as CanvasTexture, Ka as RGB_PVRTC_4BPPV1_Format, Ki as PlaneGeometry, Kn as IntType, Ko as StreamReadUsage, Kr as Mesh, Ks as ZeroStencilOp, Kt as DoubleSide, L as BoxGeometry, La as RGBA_S3TC_DXT5_Format, Li as OneMinusDstColorFactor, Ln as IncrementStencilOp, Lo as SrcAlphaFactor, Lr as LoopRepeat, Ls as WebGLCubeRenderTarget, Lt as DefaultLoadingManager, M as Bone, Ma as RGBA_ETC2_EAC_Format, Mi as OctahedronGeometry, Mn as HemisphereLightHelper, Mo as SplineCurve, Mr as Loader, Ms as VideoFrameTexture, Mt as DataTexture, N as BooleanKeyframeTrack, Na as RGBA_PVRTC_2BPPV1_Format, Ni as OneFactor, Nn as IcosahedronGeometry, No as SpotLight, Nr as LoaderUtils, Ns as VideoTexture, Nt as DataTextureLoader, O as BackSide, Oa as RGBA_ASTC_8x5_Format, Oi as NumberKeyframeTrack, On as GridHelper, Oo as Sphere, Or as LinearMipmapNearestFilter, Os as Vector2, Ot as CylinderGeometry, P as Box2, Pa as RGBA_PVRTC_4BPPV1_Format, Pi as OneMinusConstantAlphaFactor, Pn as ImageBitmapLoader, Po as SpotLightHelper, Pr as LoadingManager, Ps as WebGL3DRenderTarget, Pt as DataUtils, Q as Clock, Qa as Ray, Qi as PolarGridHelper, Qn as InterpolateSmooth, Qo as TetrahedronGeometry, Qr as MeshNormalMaterial, Qs as getByteLength, Qt as EdgesGeometry, R as BoxHelper, Ra as RGBDepthPacking, Ri as OneMinusSrcAlphaFactor, Rn as IncrementWrapStencilOp, Ro as SrcAlphaSaturateFactor, Rr as MOUSE, Rs as WebGLRenderTarget, Rt as DepthFormat, S as Audio, Sa as RGBA_ASTC_12x12_Format, Si as NormalBlending, Sn as GreaterCompare, So as ShapeUtils, Sr as LineSegments, Ss as UnsignedInt5999Type, St as CullFaceFrontBack, T as AudioListener, Ta as RGBA_ASTC_5x5_Format, Ti as NotEqualCompare, Tn as GreaterEqualDepth, To as SkeletonHelper, Tr as LinearMipMapLinearFilter, Ts as UnsignedShort5551Type, Tt as CurvePath, U as Cache, Ua as RGB_ETC1_Format, Ui as Path, Un as Int16BufferAttribute, Uo as StereoCamera, Ur as Matrix3, Us as ZeroCurvatureEnding, Ut as DirectionalLightHelper, V as BufferGeometryLoader, Va as RGB_BPTC_SIGNED_Format, Vi as PCFShadowMap, Vn as InstancedInterleavedBuffer, Vo as StaticDrawUsage, Vr as MathUtils, Vs as WireframeGeometry, Vt as DetachedBindMode, W as Camera, Wa as RGB_ETC2_Format, Wi as PerspectiveCamera, Wn as Int32BufferAttribute, Wo as StreamCopyUsage, Wr as Matrix4, Ws as ZeroFactor, Wt as DiscreteInterpolant, X as CircleGeometry, Xa as RGIntegerFormat, Xi as Points, Xn as InterpolateDiscrete, Xo as TOUCH, Xr as MeshLambertMaterial, Xs as createElementNS, Xt as DynamicDrawUsage, Y as CineonToneMapping, Ya as RGFormat, Yi as PointLightHelper, Yn as Interpolant, Yo as SubtractiveBlending, Yr as MeshDistanceMaterial, Ys as createCanvasElement, Yt as DynamicCopyUsage, Z as ClampToEdgeWrapping, Za as RawShaderMaterial, Zi as PointsMaterial, Zn as InterpolateLinear, Zo as TangentSpaceNormalMap, Zr as MeshMatcapMaterial, Zs as error, Zt as DynamicReadUsage, _ as AnimationUtils, _a as RGBA_ASTC_10x10_Format, _i as NoBlending, _n as Frustum, _o as ShaderMaterial, _r as LineBasicMaterial, _s as UniformsGroup, _t as CubicBezierCurve, a as AdditiveBlending, aa as Quaternion, ac as warn, ai as MixOperation, an as Euler, ao as RenderTarget3D, ar as LatheGeometry, as as TorusKnotGeometry, at as CompressedTextureLoader, b as ArrowHelper, ba as RGBA_ASTC_10x8_Format, bi as NoToneMapping, bn as GLSL1, bo as ShapeGeometry, br as LineDashedMaterial, bs as UnsignedInt101111Type, bt as CullFaceBack, c as AlwaysCompare, ca as R11_EAC_Format, ci as NearestFilter, cn as ExtrudeGeometry, co as ReverseSubtractEquation, cr as LessDepth, cs as TriangleStripDrawMode, ct as ConstantColorFactor, d as AmbientLight, da as RED_RGTC1_Format, di as NearestMipmapLinearFilter, dn as Float32BufferAttribute, do as SIGNED_RED_GREEN_RGTC2_Format, dr as LessEqualStencilFunc, ds as UVMapping, dt as CubeDepthTexture, ea as PositionalAudio, ec as getUnlitUniformColorSpace, ei as MeshPhysicalMaterial, en as EqualCompare, eo as RectAreaLight, er as InterpolationSamplingType, es as TextureLoader, et as ColorKeyframeTrack, f as AnimationAction, fa as REVISION, fi as NearestMipmapNearestFilter, fn as FloatType, fo as SIGNED_RED_RGTC1_Format, fr as LessStencilFunc, fs as Uint16BufferAttribute, ft as CubeReflectionMapping, g as AnimationObjectGroup, ga as RGBAIntegerFormat, gi as NeverStencilFunc, gn as FrontSide, go as Scene, gr as Line3, gs as Uniform, gt as CubeUVReflectionMapping, h as AnimationMixer, ha as RGBAFormat, hi as NeverDepth, hn as FramebufferTexture, ho as SRGBTransfer, hr as Line, hs as Uint8ClampedBufferAttribute, ht as CubeTextureLoader, i as AdditiveAnimationBlendMode, ia as QuadraticBezierCurve3, ic as setConsoleFunction, ii as MirroredRepeatWrapping, in as EquirectangularRefractionMapping, io as RenderTarget, ir as LOD, is as TorusGeometry, it as CompressedTexture, j as BatchedMesh, ja as RGBA_BPTC_Format, ji as ObjectSpaceNormalMap, jn as HemisphereLight, jo as SphericalHarmonics3, jr as LinearTransfer, js as VectorKeyframeTrack, jt as DataArrayTexture, k as BasicDepthPacking, ka as RGBA_ASTC_8x6_Format, ki as Object3D, kn as Group, ko as SphereGeometry, kr as LinearSRGBColorSpace, ks as Vector3, kt as Cylindrical, l as AlwaysDepth, la as RAD2DEG, li as NearestMipMapLinearFilter, ln as FileLoader, lo as RingGeometry, lr as LessEqualCompare, ls as TrianglesDrawMode, lt as Controls, m as AnimationLoader, ma as RGBADepthPacking, mi as NeverCompare, mn as FogExp2, mo as SRGBColorSpace, mr as LightProbe, ms as Uint8BufferAttribute, mt as CubeTexture, n as AddEquation, na as PropertyMixer, nc as mergeUniforms, ni as MeshToonMaterial, nn as EqualStencilFunc, no as RedIntegerFormat, nr as KeepStencilOp, ns as Timer, nt as CompressedArrayTexture, o as AgXToneMapping, oa as QuaternionKeyframeTrack, oc as warnOnce, oi as MultiplyBlending, on as EventDispatcher, oo as RepeatWrapping, or as Layers, os as Triangle, ot as ConeGeometry, p as AnimationClip, pa as RG11_EAC_Format, pi as NeutralToneMapping, pn as Fog, po as SIGNED_RG11_EAC_Format, pr as Light, ps as Uint32BufferAttribute, pt as CubeRefractionMapping, q as CapsuleGeometry, qa as RGB_S3TC_DXT1_Format, qi as PlaneHelper, qn as InterleavedBuffer, qo as StringKeyframeTrack, qr as MeshBasicMaterial, qs as arrayNeedsUint32, qt as DstAlphaFactor, r as AddOperation, ra as QuadraticBezierCurve, rc as probeAsync, ri as MinEquation, rn as EquirectangularReflectionMapping, ro as ReinhardToneMapping, rr as KeyframeTrack, rs as TimestampQuery, rt as CompressedCubeTexture, s as AlphaFormat, sa as QuaternionLinearInterpolant, si as MultiplyOperation, sn as ExternalTexture, so as ReplaceStencilOp, sr as LessCompare, ss as TriangleFanDrawMode, st as ConstantAlphaFactor, t as ACESFilmicToneMapping, ta as PropertyBinding, tc as log, ti as MeshStandardMaterial, tn as EqualDepth, to as RedFormat, tr as InvertStencilOp, ts as TextureUtils, tt as ColorManagement, u as AlwaysStencilFunc, ua as RED_GREEN_RGTC2_Format, ui as NearestMipMapNearestFilter, un as Float16BufferAttribute, uo as SIGNED_R11_EAC_Format, ur as LessEqualDepth, us as TubeGeometry, ut as CubeCamera, v as ArcCurve, va as RGBA_ASTC_10x5_Format, vi as NoColorSpace, vn as FrustumArray, vo as ShadowMaterial, vr as LineCurve, vs as UniformsUtils, vt as CubicBezierCurve3, w as AudioContext, wa as RGBA_ASTC_5x4_Format, wi as NormalRGPacking, wn as GreaterEqualCompare, wo as Skeleton, wr as LinearInterpolant, ws as UnsignedShort4444Type, wt as Curve, x as AttachedBindMode, xa as RGBA_ASTC_12x10_Format, xi as NormalAnimationBlendMode, xn as GLSL3, xo as ShapePath, xr as LineLoop, xs as UnsignedInt248Type, xt as CullFaceFront, y as ArrayCamera, ya as RGBA_ASTC_10x6_Format, yi as NoNormalPacking, yn as GLBufferAttribute, yo as Shape, yr as LineCurve3, ys as UnsignedByteType, yt as CubicInterpolant, z as BufferAttribute, za as RGBFormat, zi as OneMinusSrcColorFactor, zn as InstancedBufferAttribute, zo as SrcColorFactor, zr as Material, zs as WebGPUCoordinateSystem, zt as DepthStencilFormat } from "./three.core-eNd2qU5R.js";
...
function WebGLCubeMaps(renderer) {
	...
	function get(texture) {
		if (texture && texture.isTexture) {
			...
			if (mapping === EquirectangularReflectionMapping || mapping === EquirectangularRefractionMapping) if (cubemaps.has(texture)) {
...
var envMapModeDefines = { [CubeRefractionMapping]: "ENVMAP_MODE_REFRACTION" };
...
function WebGLLights(extensions) {
	...
	function setup(lights) {
		...
		for (let i = 0, l = lights.length; i < l; i++) {
			...
			let shadowMap = null;
			if (light.shadow && light.shadow.map) if (light.shadow.map.texture.format === RGFormat) shadowMap = light.shadow.map.texture;
...
function WebGLTextures(_gl, extensions, state, properties, capabilities, utils, info) {
	...
	function uploadTexture(textureProperties, texture, slot) {
		...
		if (source.version !== sourceProperties.__version || forceUpload === true) {
			...
			if (texture.isDepthTexture) {
				...
				for (let i = 0, il = mipmaps.length; i < il; i++) {
					mipmap = mipmaps[i];
					if (texture.format !== RGBAFormat) if (glFormat !== null) if (useTexStorage) {
	...
	function setupDepthTexture(framebuffer, renderTarget, cubeFace) {
		...
		if (isCube) {
			...
			if (textureProperties.__webglTexture === void 0) {
				...
				let glInternalFormat;
				if (renderTarget.depthTexture.format === DepthFormat) glInternalFormat = _gl.DEPTH_COMPONENT24;
				else if (renderTarget.depthTexture.format === DepthStencilFormat) glInternalFormat = _gl.DEPTH24_STENCIL8;
		...
		if (renderTarget.depthTexture.format === DepthFormat) if (useMultisampledRTT(renderTarget)) multisampledRTTExt.framebufferTexture2DMultisampleEXT(_gl.FRAMEBUFFER, glAttachmentType, glTextureType, webglDepthTexture, 0, samples);
		else _gl.framebufferTexture2D(_gl.FRAMEBUFFER, glAttachmentType, glTextureType, webglDepthTexture, 0);
		else if (renderTarget.depthTexture.format === DepthStencilFormat) if (useMultisampledRTT(renderTarget)) multisampledRTTExt.framebufferTexture2DMultisampleEXT(_gl.FRAMEBUFFER, glAttachmentType, glTextureType, webglDepthTexture, 0, samples);
		else _gl.framebufferTexture2D(_gl.FRAMEBUFFER, glAttachmentType, glTextureType, webglDepthTexture, 0);
	...
	function verifyColorSpace(texture, image) {
		...
		if (colorSpace !== LinearSRGBColorSpace && colorSpace !== NoColorSpace) if (ColorManagement.getTransfer(colorSpace) === SRGBTransfer) {
			if (format !== RGBAFormat || type !== UnsignedByteType) warn("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.");
...
function WebGLUtils(gl, extensions) {
	function convert(p, colorSpace = NoColorSpace) {
		...
		if (p === RGB_S3TC_DXT1_Format || p === RGBA_S3TC_DXT1_Format || p === RGBA_S3TC_DXT3_Format || p === RGBA_S3TC_DXT5_Format) if (transfer === SRGBTransfer) {
	...
	*/
	constructor(parameters = {}) {
		...
		*/
		...
		initGLContext();
		if (_outputBufferType !== UnsignedByteType) output = new WebGLOutput(_outputBufferType, canvas.width, canvas.height, depth, stencil);
